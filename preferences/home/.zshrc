...
# Dynamically update the hash table for commands during completion
zstyle ':completion:*' rehash true
# autocomplete on lowercase etc
...
autoload -Uz clean git_status git_branch git_remote_name git_root_level
